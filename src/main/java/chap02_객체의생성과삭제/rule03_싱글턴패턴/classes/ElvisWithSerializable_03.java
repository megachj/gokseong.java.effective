package chap02_객체의생성과삭제.rule03_싱글턴패턴.classes;
 ...
 */
public class ElvisWithSerializable_03 implements Serializable {
    transient private static final ElvisWithSerializable_03 INSTANCE = new ElvisWithSerializable_03();

    private ElvisWithSerializable_03() {
        if (INSTANCE != null)
    ...
    public static ElvisWithSerializable_03 getInstance() {
        return INSTANCE;
    }
