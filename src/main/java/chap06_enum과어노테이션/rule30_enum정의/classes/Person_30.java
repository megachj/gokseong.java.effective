...
@Getter
public class Person_30 {
    private final String name;
    private final int age;

    // 근데 이런 클래스 변수는 멀티 스레드 환경에서 안전하지 않을 것 같다.
    private static final Map<String, Person_30> stringToPerson = new HashMap<>();
    static {
    ...
    public Person_30(String name, int age) {
        this.name = name;
        this.age = age;
    ...
    public static Person_30 fromString(String name) {
