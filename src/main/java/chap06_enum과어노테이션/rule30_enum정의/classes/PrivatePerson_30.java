package chap06_enum과어노테이션.rule30_enum정의.classes;
...
public class PrivatePerson_30 {
    ...
    private static final PrivatePerson_30 p1 = new PrivatePerson_30("kim", 10);
    private static final PrivatePerson_30 p2 = new PrivatePerson_30("choe", 20);

    // 여기 있는 경우엔, 생성자에서 보는 경우 null이 발생한다.
    private static final Map<String, PrivatePerson_30> stringToPrivatePerson = new HashMap<>();
    ...
    private PrivatePerson_30(String name, int age) {
        this.name = name;
        this.age = age;
    ...
    public static PrivatePerson_30 fromString(String name) {
